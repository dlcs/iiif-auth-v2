...
namespace IIIFAuth2.API.Data.Migrations
{
    ...
    [Migration("20230714104813_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IIIFAuth2.API.Data.Entities.AccessService", b =>
                {
                    ...
                    b.Property<Guid?>("ChildAccessServiceId")
                        .HasColumnType("uuid")
                        .HasColumnName("child_access_service_id");
                    ...
                    b.Property<Guid?>("ParentAccessServiceId")
                        .HasColumnType("uuid")
                        .HasColumnName("parent_access_service_id");
                    ...
                    b.HasIndex("ParentAccessServiceId")
                        .HasDatabaseName("ix_access_services_parent_access_service_id");
            ...
            modelBuilder.Entity("IIIFAuth2.API.Data.Entities.AccessService", b =>
                {
                    b.HasOne("IIIFAuth2.API.Data.Entities.AccessService", "ParentAccessService")
                        .WithMany("ChildAccessServices")
                        .HasForeignKey("ParentAccessServiceId")
                        .HasConstraintName("fk_access_services_access_services_parent_access_service_id");
                    ...
                    b.Navigation("ParentAccessService");
            ...
            modelBuilder.Entity("IIIFAuth2.API.Data.Entities.AccessService", b =>
                {
                    b.Navigation("ChildAccessServices");
                });
